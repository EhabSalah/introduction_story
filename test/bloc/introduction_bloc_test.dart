...
void main() {
  ...
  group(
    ...
    () {
      ...
      test('Throws AssertionError when stories count equals to zero.', () {
        expect(
          () => IntroductionBloc(storiesLength: 0),
      ...
      test(
          ...
          'story duration < the minimum allowed duration', () {
        expect(
          () => IntroductionBloc(storiesLength: 1, storyDuration: 1),
          throwsA(isA<AssertionError>()),
        );
      });
      ...
      blocTest<IntroductionBloc, IntroductionState>(
        ...
        build: () => IntroductionBloc(
          storiesLength: 1,
          ticker: ticker,
          completeWatchProgress: completeProgress,
        ),
      ...
      blocTest<IntroductionBloc, IntroductionState>(
        'IntroductionPrevious reset the current and last story progress '
        'and decrements the current index by 1',
        build: () => IntroductionBloc(
          storiesLength: 2,
          ticker: ticker,
          completeWatchProgress: completeProgress,
      ...
      blocTest<IntroductionBloc, IntroductionState>(
        'IntroductionPrevious emits nothing if the current index '
        'is the first one',
      ...
      blocTest<IntroductionBloc, IntroductionState>(
        'NextIntroductionStory emits IntroductionRunInProgress '
        'with complete currentIndex',
        build: () => IntroductionBloc(
          storiesLength: 2,
          ticker: ticker,
          completeWatchProgress: completeProgress,
      ...
      blocTest<IntroductionBloc, IntroductionState>(
        'NextIntroductionStory completes if the running story is the last one',
        build: () => IntroductionBloc(
          storiesLength: 2,
          ticker: ticker,
          completeWatchProgress: completeProgress,
